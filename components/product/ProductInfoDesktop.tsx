...
function ProductInfoDesktop({
  ...
  return (
    <div class="grid grid-cols-3 gap-6" id={id}>
      {/* Code and name */}
        ...
        <div class="grid grid-cols-2 gap-6">
          ...
          <div>
            <div>
              ...
              {brand && (
                <a
                  class="text-primary text-sm underline hover:text-info p-2 flex w-full border-b border-neutral"
                    ...
                    {attr.name == "Princípio ativo"
                      ? (
                        <a
                          ...
                          href={`/${
                            formatarTextoParaHref(attr?.value ?? "")
                          }/pa`}
                        >
                          <Icon
                            id={attr.idIcon}
      ...
      <div>
        ...
        {productOffers && (
          <ProductBuyBox
            ...
            productVariantIdParams={productVariantIdParams}
          />
        )}
      </div>
    </div>
