...
export function Preview(props: Props) {
  ...
  return (
    <>
      ...
      <Section {...props} />
      <div class={`flex flex-col gap-4 text-info w-full ${adminColorMode}`}>
...
const TextColorsPreview = () => {
  ...
  return (
    <div class="bg-base-100 overflow-x-auto rounded-lg flex flex-row p-2 gap-2 text-sm md:text-info">
