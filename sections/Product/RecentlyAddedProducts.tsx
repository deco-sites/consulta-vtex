export { default } from "../../components/product/RecentlyAddedProducts.tsx";

export function LoadingFallback() {
  return (
    <div class="h-[1800px] lg:h-[600px] flex justify-center flex-col px-4 lg:px-10 gap-6 py-4 lg:py-10 mx-auto max-w-[1366px]">
