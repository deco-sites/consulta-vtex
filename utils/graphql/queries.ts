...
const SingleProductPart = gql`
  fragment SingleProductPart on SingleProduct {
    ...
    attributeSelections(
      includeParentIdVariants: $includeParentIdVariants
...
export const GetCategoryProducts = {
  query: gql`
    query GetCategoryProducts($categoryId: Long!) {
      categories(categoryIds: [$categoryId], first: 1) {
        nodes {
          name
          products(first: 50) {
            edges {
...
export const GetCategoryChildren = {
  query: gql`
    query GetCategoryChildrens($urls: [String], $first: Int) {
      categories(first: $first, urls: $urls) {
        nodes {
          children {
            name
          }
...
export const GetCart = {
  fragments: [Checkout],
  query: gql`
    query GetCart($checkoutId: String!) {
...
export const AddCoupon = {
  fragments: [Checkout],
  query: gql`
    mutation AddCoupon($checkoutId: Uuid!, $coupon: String!) {
      checkout: checkoutAddCoupon(checkoutId: $checkoutId, coupon: $coupon) {
        ...Checkout
      }
    }
  `,
...
export const HotsiteById = {
  ...
  query: gql`
    query Hotsite(
      ...
      result: hotsite(hotsiteId: $hotsiteId, partnerAccessToken: $partnerAccessToken) {
        aggregations {
          filters {
            field
            origin
...
export const ProductFragmentSearch = gql`
  fragment Product on Product {
    mainVariant
    productName
    productId
...
export const GetProductPage = {
  ...
  query: gql`
    query GetProductPage(
      $filtersParent: ProductExplicitFiltersInput!
      $firstParent: Int!
      $sortDirectionParent: SortDirection!
      $sortKeyParent: ProductSortKeys
      $afterParent: String
      $filtersSecondary: ProductExplicitFiltersInput!
      $firstSecondary: Int!
      $sortDirectionSecondary: SortDirection!
      $sortKeySecondary: ProductSortKeys
      $afterSecondary: String
      $categoryId: Long!
      $filtersGenerics: [ProductFilterInput]
      $operationGenerics: Operation!
      $queryGenerics: String
      $limitGenerics: Int
      $ignoreDisplayRulesGenerics: Boolean
      $maximumPriceGenerics: Decimal
      $limitRecomendation: Int
      $url: String
    ) {
      parentsProducts: products(
        filters: $filtersParent
        first: $firstParent
        sortDirection: $sortDirectionParent
        sortKey: $sortKeyParent
        after: $afterParent
      ) {
        nodes {
          ...Product
      ...
      productSecondary: products(
        filters: $filtersSecondary
        first: $firstSecondary
        sortDirection: $sortDirectionSecondary
        sortKey: $sortKeySecondary
        after: $afterSecondary
      ) {
        nodes {
          ...Product
        }
      ...
      productsCategories: categories(categoryIds: [$categoryId], first: 1) {
        nodes {
          name
          products(first: 50) {
            edges {
      ...
      productsGenerics: search(
        query: $queryGenerics
        operation: $operationGenerics
        ignoreDisplayRules: $ignoreDisplayRulesGenerics
      ) {
        productsByOffset(
          limit: $limitGenerics
          maximumPrice: $maximumPriceGenerics
          filters: $filtersGenerics
        ) {
          items {
            ...Product
          }
      ...
      productRecomendations: hotsite(url: $url) {
        productsByOffset(limit: $limitRecomendation, sortKey: RANDOM) {
          items {
            ...Product
          }
        }
