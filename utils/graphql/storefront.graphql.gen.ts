...
export type ApplyPolicy = "AFTER_RESOLVER" | "BEFORE_RESOLVER";
...
export type BuyTogetherType = "CAROUSEL" | "PRODUCT";
...
export type CheckoutProductSubscription = {
  ...
  availableSubscriptions?: Maybe<
    Array<Maybe<CheckoutProductSubscriptionItemNode>>
  >;
...
export type CheckoutResetType = "PAYMENT";
...
export type Customer = Node & {
  ...
  checkingAccountHistory?: Maybe<
    Array<Maybe<CustomerCheckingAccountHistoryNode>>
  >;
  /** Taxpayer identification number for businesses. */
  cnpj?: Maybe<Scalars["String"]["output"]>;
  /** Entities legal name. */
...
export type CustomerCreateInput = {
  ...
  informationGroupValues?: InputMaybe<
    Array<InputMaybe<InformationGroupValueInput>>
  >;
...
/** The user login origin. */
export type LoginOrigin = "SIMPLE" | "SOCIAL";

/** The user login type. */
export type LoginType = "AUTHENTICATED" | "NEW" | "SIMPLE";
...
export type ProductRecommendationAlgorithm = "DEFAULT";
...
export type QueryRoot = {
   ...
   */
  newsletterInformationGroupFields?: Maybe<
    Array<Maybe<InformationGroupFieldNode>>
  >;
  node?: Maybe<Node>;
...
/** The simple login type. */
export type SimpleLoginType = "NEW" | "SIMPLE";
...
export type Status = "ACTIVE" | "CANCELED" | "PAUSED";
...
export type CheckoutFragment = {
  ...
  products?: Array<{
    ...
    subscription?: {
      availableSubscriptions?: Array<{
        ...
        recurringTypeId: any;
        selected: boolean;
        subscriptionGroupDiscount: any;
        subscriptionGroupId: any;
      } | null> | null;
      selected?: {
        selected: boolean;
        name?: string | null;
  ...
  selectedPaymentMethod?: {
    ...
    scripts?: Array<string | null> | null;
    installments?: Array<{
      adjustment: number;
      number: number;
      total: number;
...
export type ProductFragment = {
  ...
  prices?: {
    ...
    wholesalePrices?: Array<{ price: any; quantity: number } | null> | null;
  } | null;
  productBrand?: {
    fullUrlLogo?: string | null;
    logoUrl?: string | null;
    name?: string | null;
    alias?: string | null;
  } | null;
...
export type BuyListFragment = {
  ...
  stock?: any | null;
  variantName?: string | null;
  parallelOptions?: Array<string | null> | null;
  urlVideo?: string | null;
  buyListId: number;
  attributes?: Array<{
    name?: string | null;
  ...
  attributeSelections?: {
    ...
    matrix?: {
      column?: {
        displayType?: string | null;
        name?: string | null;
        values?: Array<{ value?: string | null } | null> | null;
      } | null;
      data?: Array<Array<{
        available: boolean;
        productVariantId: any;
  ...
  buyTogether?: Array<{ productId?: any | null } | null> | null;
  promotions?: Array<{
    content?: string | null;
    disclosureType?: string | null;
    id: any;
...
export type SingleProductPartFragment = {
  mainVariant?: boolean | null;
  productName?: string | null;
  productId?: any | null;
  alias?: string | null;
...
export type RestockAlertNodeFragment = {
  email?: string | null;
  name?: string | null;
  productVariantId: any;
  requestDate: any;
...
export type ShippingQuoteFragment = {
  id?: string | null;
  type?: string | null;
  name?: string | null;
  value: number;
  ...
  products?: Array<{ productVariantId: number; value: number } | null> | null;
};
...
export type WishlistReducedProductFragment = {
  productId?: any | null;
  productName?: string | null;
};
...
export type GetProductQueryVariables = Exact<{
  productId: Scalars["Long"]["input"];
  includeParentIdVariants?: InputMaybe<Scalars["Boolean"]["input"]>;
  includeAllVariants?: InputMaybe<Scalars["Boolean"]["input"]>;
  partnerAccessToken?: InputMaybe<Scalars["String"]["input"]>;
}>;
...
// Definindo as tipagens para a consulta de produtos por categoria
export type GetCategoryProductsQueryVariables = Exact<{
  categoryId: Scalars["Long"]["input"];
}>;
export type GetCategoryChildrenVariables = Exact<{
  first: number;
  urls: string[];
}>;

export type GetCategoryProductsQuery = {
  categories: {
    nodes: Array<{
      name: string;
      hotsiteUrl: string;
...
export type GetCategoryChildrens = {
  categories: {
    nodes: Array<{
      children: Array<{
        name: string;
...
export type SearchQuery = {
  result?: {
    ...
    forbiddenTerm?: { text?: string | null; suggested?: string | null } | null;
    productsByOffset?: {
      page: number;
      pageSize: number;
      totalCount: number;
...
export type ProductRestockAlertMutation = {
  productRestockAlert?: {
    email?: string | null;
    name?: string | null;
    productVariantId: any;
...
export type CreateNewsletterRegisterMutation = {
...
export type ShippingQuotesQuery = {
...
export type GetUserQuery = {
  customer?: {
    ...
    wishlist?: {
      products: SingleProductFragment[] | null;
    } | null;
  } | null;
};
...
export type GetUrlQuery = {
  uri?: {
    hotsiteSubtype?: HotsiteSubtype | null;
    kind: UriKind;
    partnerSubtype?: PartnerSubtype | null;
    productAlias?: string | null;
    productCategoriesIds?: Array<number> | null;
...
export type SendGenericFormMutation = {
  sendGenericForm?: { isSuccess: boolean } | null;
};
...
export type HotsiteQueryVariables = Exact<{
  ...
  partnerAccessToken?: InputMaybe<Scalars["String"]["input"]>;
  ignoreDisplayRules?: boolean;
  hotsiteId?: InputMaybe<Scalars["Int"]["input"]>;
}>;

export type HotsiteQuery = {
  result?: {
    endDate?: any | null;
...
export type AddKitMutationVariables = Exact<{
  input: CheckoutKitInput;
  customerAccessToken?: InputMaybe<Scalars["String"]["input"]>;
  recaptchaToken?: InputMaybe<Scalars["String"]["input"]>;
}>;

export type AddKitMutation = {
  checkout?: {
    checkoutId: any;
    shippingFee: any;
    subtotal: any;
...
export type RemoveKitMutationVariables = Exact<{
  input: CheckoutKitInput;
  customerAccessToken?: InputMaybe<Scalars["String"]["input"]>;
  recaptchaToken?: InputMaybe<Scalars["String"]["input"]>;
}>;

export type RemoveKitMutation = {
  checkout?: {
    checkoutId: any;
    shippingFee: any;
    subtotal: any;
...
export type CheckoutPartnerAssociateMutation = {
  checkout?: {
    checkoutId: any;
    shippingFee: any;
    subtotal: any;
...
export type GetProductsQueryHome = {
  totalCount: number;
  nodes?: Array<{
    mainVariant?: boolean | null;
    productName?: string | null;
...
export interface HomePageQuery {
  anticoagulante?: GetProductsQueryHome;
  colageno?: GetProductsQueryHome;
  descongestionanteNasal: GetProductsQueryHome;
  diabetes: GetProductsQueryHome;
  disfuncaoEretil?: GetProductsQueryHome;
  leiteInfantil?: GetProductsQueryHome;
  medicamentosAltoCusto?: GetProductsQueryHome;
  pararDeFumar?: GetProductsQueryHome;
}
export type ProductPageQueryVariables = Exact<{
  filtersParent: ProductExplicitFiltersInput;
  firstParent: Scalars["Int"]["input"];
  sortDirectionParent: SortDirection;
  sortKeyParent?: InputMaybe<ProductSortKeys>;
  afterParent?: InputMaybe<Scalars["String"]["input"]>;
  filtersSecondary: ProductExplicitFiltersInput;
  firstSecondary: Scalars["Int"]["input"];
  sortDirectionSecondary: SortDirection;
  sortKeySecondary?: InputMaybe<ProductSortKeys>;
  afterSecondary?: InputMaybe<Scalars["String"]["input"]>;
  categoryId: Scalars["Long"]["input"];
  operationGenerics: Operation;
  queryGenerics?: InputMaybe<Scalars["String"]["input"]>;
  limitGenerics?: number;
  ignoreDisplayRulesGenerics?: boolean;
  maximumPriceGenerics?: InputMaybe<Scalars["Decimal"]["input"]>;
  filtersGenerics?: InputMaybe<
    Array<InputMaybe<ProductFilterInput>> | InputMaybe<ProductFilterInput>
  >;
  limitRecomendation: Scalars["Int"]["input"];
  url?: InputMaybe<Scalars["String"]["input"]>;
}>;
export interface ProductPageQuery {
  parentsProducts?: GetProductsQueryHome;
  productSecondary?: GetProductsQueryHome;
  productsCategories?: {
    nodes: Array<{
      name: string;
      hotsiteUrl: string;
