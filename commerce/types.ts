...
import { AttributeSubstance, CategoryThumb } from "./attributesTypes.ts";
import { Product as ContentProduct, ProductVariation } from "./ContentTypes.ts";
...
export interface CategoryValue extends Omit<Thing, "@type"> {
  "@type": "PropertyValue";
  /** The upper value of some characteristic or property. */
  maxValue?: number;
  /** The lower value of some characteristic or property. */
  ...
  /** A secondary value that provides additional information on the original value, e.g. a reference temperature or a type of measurement. */
  valueReference?: string | undefined;
}

export interface PropertyValueVariant extends Omit<Thing, "@type"> {
  "@type": "PropertyValue";
  /** The upper value of some characteristic or property. */
  maxValue?: number;
  /** The lower value of some characteristic or property. */
...
export interface OfferSellers extends Omit<Thing, "@type"> {
  "@type": "PropertyValue";
  /** The upper value of some characteristic or property. */
  name?: string;
  /** The lower value of some characteristic or property. */
...
export interface BuyBox extends Omit<Thing, "@type"> {
  "@type": "PropertyValue";
  maximumPrice?: number;
  minimumPrice?: number;
...
export interface Product extends Omit<Thing, "@type"> {
   ...
   */
  additionalProperty?: PropertyValue[];
  categoryProperty?: CategoryValue[];
  variantsProperty?: PropertyValueVariant[];
...
export interface ProductDetailsPage {
  ...
  productMainContent: ContentProduct | null;
  productContent?: ProductVariation | null;
}
export interface DetailsPageLeaflet {
  "@type": "ProductDetailsPage";
  breadcrumbList?: BreadcrumbList;
  product?: Product;
  seo?: Seo | null;
...
export interface ProductListingPage {
  ...
  seo?: Seo | null;
  contentSeoSubstance?: AttributeSubstance | null;
  contentSeo?: string | null;
  thumbmails?: CategoryThumb[];
  titlePage?: string;
  descriptionPage?: string;
  categoryContent?: CategoryThumb;
  prescriptionType?: PrescriptionType | null;
  relatedTerms?: RelatedTermsItens[] | null;
...
export interface ListingFromAtoZ {
  pageInfo: {
    currentPage: number;
    nextPage: string | undefined;
    previousPage: string | undefined;
